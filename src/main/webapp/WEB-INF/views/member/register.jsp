				...
				<section id="container">
					<form class="col" action="${contextPath}/member/addMember.do"
						...
						<div class="">
							...
							<div class="col-2">
									<input class="form-control" type="text" id="sample4_postcode" name="user_addr" placeholder="우편번호">
							</div>
							<div class="col-3">
								<div class="col-6">
							...
							<div class="col">
									<input class="form-control" type="text" id="sample4_roadAddress"
										name="user_addr" placeholder="도로명주소" />
							</div>
							<div class="col">
									<input class="form-control" type="text" d="sample4_jibunAddress" 
