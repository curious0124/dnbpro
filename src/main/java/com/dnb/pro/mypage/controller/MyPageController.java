...
public interface MyPageController {
	...
	public ModelAndView myResqDetail(@RequestParam("user_id")  String user_id,HttpServletRequest request, HttpServletResponse response)  throws Exception;
	...
	public ModelAndView cancelMyRent(@RequestParam("resq_num")  String order_id,HttpServletRequest request, HttpServletResponse response)  throws Exception;
